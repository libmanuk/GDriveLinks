...
// Define Constants.
define('DEFAULT_LINK_TARGET_VALUE', '1');
...
public function _linkField($text, $args) {
    ...
    $gdriveid = $text;
    $gdriveid = str_replace("://drive.google.com/file/d/","",$gdriveid);
    $gdriveid = str_replace("/preview","",$gdriveid);
    $gdriveid = str_replace("/view","",$gdriveid);
    $gdriveid = str_replace("https","",$gdriveid);
    $gdriveid = str_replace("http","",$gdriveid);
